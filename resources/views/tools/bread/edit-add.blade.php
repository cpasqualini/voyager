                    ...
                    <div class="panel panel-primary panel-bordered">
                        ...
                        <div class="panel-body">
                            ...
                            <div class="row clearfix">
                                ...
                                <div class="col-md-2 form-group">
                                    <label for="generate_bread_controller">{{ __('voyager::bread.generate_bread_controller') }}</label><br>
                                    <?php $checked = (isset($dataType->generate_bread_controller) && $dataType->generate_bread_controller == 1) ? true : (isset($generate_bread_controller) && $generate_bread_controller) ? true : false; ?>
                                    <input type="checkbox" name="generate_bread_controller" class="toggleswitch" data-on="{{ __('voyager::generic.yes') }}" data-off="{{ __('voyager::generic.no') }}"
                                           @if($checked) checked @endif>
                                </div>
                                <div class="col-md-2 form-group">
